    ...
    <section id="services" className="relative w-full h-screen">
      <div className="container mx-auto py-20 px-8 md:px-0">
        <div className="flex flex-col w-full items-center justify-center">
          ...
          <div className="flex flex-col gap-y-20 md:w-[520px] w-full md:mt-20 mt-10">
            <motion.div
              initial={{
                y: -50,
                opacity: 0,
            ...
            >
              ...
              <p className="text-main-gray md:text-xl text-base font-medium tracking-tighter-[1.25px]">
